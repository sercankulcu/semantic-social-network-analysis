 ...
 * prepares web page, takes user id input and loads generated .js files
 * 
 * */
...
public class WebServer extends AbstractHandler {
	...
	private void preparePage(HttpServletResponse response) throws IOException {
	...
	private void loadJavascript(HttpServletResponse response) throws IOException {
